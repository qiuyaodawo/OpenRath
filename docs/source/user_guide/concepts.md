...
- **Composition** — A [`Workflow`](workflow_agent.md) aggregates named [`Agent`](workflow_agent.md)
...
**Stable** areas include core dataclasses (`Session`, `Agent`, `Provider`),
...
|-------|-----------|----------------|
| Flow façade | `rath.flow` | `Workflow`, `Agent`, tool table helpers |
