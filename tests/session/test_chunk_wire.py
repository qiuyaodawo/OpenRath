"""Chunk rows + chunk_table → LLM wire-format round-trip.

Consolidated from (every test function name preserved verbatim):
- test_chunk_messages.py        (chunk_table_to_messages)
- test_llm_message_wire.py      (to_create_kwargs OpenAI serialization)
"""
...
# ---------------------------------------------------------------------------
# to_create_kwargs OpenAI wire serialization
# ---------------------------------------------------------------------------
